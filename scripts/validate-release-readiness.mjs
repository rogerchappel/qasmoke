...
requireField(scripts['registry:availability'], 'package.json scripts must include registry:availability');
...
if (fs.existsSync(workflowDir)) {
  ...
  if (fs.existsSync(releasePath)) {
    ...
    requireField(/registry:availability/.test(release), 'release workflow must use the fail-closed registry availability check');
